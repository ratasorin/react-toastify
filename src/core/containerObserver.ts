...
import { canBeRendered, getAutoCloseDelay, isFn, isNum, parseClassName, toToastItem } from '../utils';
    ...
    toasts.forEach(t => {
      if (id == null || id === t.props.toastId) {
        if (isFn(t.toggle)) {
          ...
          console.warn('OOPS  t.toggle is:', t.toggle, ' for component:', t.props.toastId);
        }
      }
    });
  };
